...
| CTX-PERFORMANCE-SCALE | `summaries/performance_scalability_audit.md` | Static audit plus accepted R-010 History benchmark/query-plan evidence | Ready | Refresh after scalability implementation or benchmark evidence | `02_research_tasks/R-010_history_benchmark_query_plan.md` |
